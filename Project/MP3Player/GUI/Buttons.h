...
static BTN vol_slider = {S_SQUARE, 132, 8, 4, 24};   // always starts at 60% volume, other positions handled in lcdHandler
...
const BTN progress_square = {S_SQUARE, 5, 124, 230, 16};
static BTN innerProgress_square = {S_SQUARE, 9, 128, 222, 8};
